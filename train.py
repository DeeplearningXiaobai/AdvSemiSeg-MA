...
DATA_LIST_PATH = './dataset/voc_list/train.txt'
IGNORE_LABEL = 255
INPUT_SIZE = '512,512'
...
def main():
    ...
    if args.partial_data is None:
        ...
        trainloader = data.DataLoader(train_dataset,
                                      batch_size=args.batch_size, sampler=train_sampler, num_workers=2, pin_memory=True)
        trainloader_remain = data.DataLoader(train_dataset,
                                             batch_size=args.batch_size, sampler=train_remain_sampler, num_workers=2,
                                             pin_memory=True)
        trainloader_gt = data.DataLoader(train_gt_dataset,
                                         batch_size=args.batch_size, sampler=train_gt_sampler, num_workers=2,
                                         pin_memory=True)
